...
import { getIdb, getDatabaseFromIndexedDb, editPartialDatabaseInIndexedDb } from 'utilities/idb';

export async function PatchDatabase(event: FetchEvent, match: RegExpExecArray|null, formData: Record<string, string>, referrer: Referrer) {
