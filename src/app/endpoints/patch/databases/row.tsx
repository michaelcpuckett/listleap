import { getIdb, getDatabaseFromIndexedDb, reorderRowInIndexedDb, editRowInIndexedDb } from 'utilities/idb';
import { Referrer } from 'shared/types';

export async function PatchDatabaseRow(event: FetchEvent, match: RegExpExecArray|null, formData: Record<string, string>, referrer: Referrer) {
